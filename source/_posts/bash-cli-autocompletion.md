...
<a href="https://github.com/SierraSoftworks/bash-cli">Bash CLI</a> then
go <a href="/2016/12/12/bash-cli/">read it now</a>. 
{% endalert %}
...
<script type="text/javascript" src="https://asciinema.org/a/b61d9hay2p1labwayfyg19aq6.js" id="asciicast-b61d9hay2p1labwayfyg19aq6" async></script>