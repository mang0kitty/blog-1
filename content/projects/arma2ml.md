...
*As of version **1.8.1.0** you can now use a parameters file with command line options. This allows you to run the following ArmA2ML.exe <path to file> -debug -ga=off without any issues.*
